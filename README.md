...
* [`src/cljs/trinus/`](src/cljs/trinus/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/trinus/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `trinus` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/trinus/config.cljs) defaults to `true` in
...
```clj
(ns trinus.example
  (:require [trinus.config :as config])
